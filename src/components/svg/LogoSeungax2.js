		...
		return (
			...
			preserveAspectRatio="xMidYMid meet">
				...
				fill="#000000" stroke="none">
					<path className="s twinkAni" fill="url(#editing-gradient-gradient)" d="M166 1075 c-51 -18 -102 -69 -122 -122 -12 -32 -15 -65 -12 -131 5
					...
					<path className="u" fill="url(#editing-gradient-gradient)" d="M1202 653 c4 -491 7 -506 82 -578 51 -50 99 -65 206 -65 98 0 147 13
					...
					<path className="n twinkAni2" fill="url(#editing-gradient-gradient)" d="M1920 550 l0 -530 70 0 70 0 0 338 1 337 143 -335 143 -335 56 -3 57
					-3 0 531 0 530 -70 0 -70 0 -1 -327 -1 -328 -22 50 c-13 28 -76 175 -141 328
					l-117 277 -59 0 -59 0 0 -530z"/>

					<path className="a" fill="url(#editing-gradient-gradient)" d="M3475 1058 c-21 -91 -215 -1016 -215 -1025 0 -9 22 -13 75 -13 69 0
